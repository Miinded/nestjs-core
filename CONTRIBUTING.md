...
git clone https://github.com/miinded/nestjs-core.git
cd nestjs-core
...
.
├── packages/
│   ├── nestjs-db-options/    # @miinded/nestjs-db-options — TypeORM key/value options store
│   │   └── src/
│   │       ├── dtos/         # OPTION, OPTION_FORMAT types
│   │       ├── entities/     # OptionEntity, OptionRepository
│   │       ├── migrations/   # Initial DB migration
│   │       ├── service/      # OptionService
│   │       └── index.ts      # Public barrel export
│   └── nestjs-redis-cache/   # @miinded/nestjs-redis-cache — ioredis cache service
│       └── src/
│           ├── common/       # RedisConfig, getRedisConfig util
